...
export class FileDownloadLinkComponent implements OnInit {
  ...
  this.bitstreamPath$.subscribe(value=>{console.log('bitstreamPath$ ',value);});
  console.log('auth',this.authorizationService.isAuthorized(FeatureID.CanRequestACopy, isNotEmpty(this.bitstream) ? this.bitstream.self : undefined));
  }
